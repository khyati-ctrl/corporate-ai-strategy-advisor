        ...
        <TopBar
          ...
          actions={
            <Link href="/analysis/new"
              ...
              style={{ padding: "0.875rem 1.75rem", fontSize: "0.8rem", textTransform: "uppercase", letterSpacing: "0.08em", display: "flex", alignItems: "center", gap: "0.5rem", textDecoration: "none" }}>
